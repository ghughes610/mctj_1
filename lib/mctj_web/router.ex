defmodule MctjWeb.Router do
  use MctjWeb, :router

  import MctjWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {MctjWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: MctjWeb.Telemetry
    end
  end
  ...
  scope "/", MctjWeb do
    ...
    live "/users/new_exercise", ExerciseLive.FormComponent, :index
